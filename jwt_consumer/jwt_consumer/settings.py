"""
Django settings for jwt_consumer project.
...
SECRET_KEY = 'django-insecure-f^+88q453ko&*1shdlm4jtb+q4@(v)s=$$6238a%2jxq^%9ukr'
...
ROOT_URLCONF = 'jwt_consumer.urls'
...
WSGI_APPLICATION = 'jwt_consumer.wsgi.application'
